...
import { colorSystemServer, connectionSystemServer, gameLoopSystemServer, markerSystemServer, syncSystemServer, type System } from "game/systems.ts"
...
export class ServerWorld implements World, Receiver {
     ...
     */
    #messageAllowlist: ReadonlyArray<keyof MessageRegistry> = [ "UpdateColors", "Mark", "RequestRematch" ]
